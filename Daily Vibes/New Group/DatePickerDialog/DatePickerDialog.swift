//// from https://github.com/squimer/DatePickerDialog-iOS-Swift/blob/master/Sources/DatePickerDialog.swift
//
//import Foundation
//import UIKit
//
...
//        let rect = CGRect(x: 0, y: 30, width: 0, height: 0)
//        let view = UIView.init(frame: rect)
//        
//        view.frame.size = CGSize.init(width: 300, height: 216)
...
////        datePicker.frame = CGRect(x: 0, y: 30, with:0, height: 0)
////        datePicker.frame = CGRect.init(x: 0, y: 30, width: 300, height: 216)
...
//        let result = view as UIDatePicker
//        return result
//    }
//    
