...
final class TwoTextFieldsViewController: UIViewController {
    ...
    fileprivate lazy var textFieldView: UIView = UIView(frame: CGRect.zero)
    fileprivate lazy var textFieldOne: TextField = TextField(frame: CGRect.zero)
    fileprivate lazy var textFieldTwo: TextField = TextField(frame: CGRect.zero)
