...
open class MarkdownChecklistChecked: MarkdownLevelElement {
    
    fileprivate static let regex = "^(\\[X\\])\\s*(.+)$"
    ...
    open var regex: String {
        ...
        return String(format: MarkdownChecklistChecked.regex, level)
    }
    
    public init(font: MarkdownFont? = nil, maxLevel: Int = 0, indicator: String = "☑︎",
